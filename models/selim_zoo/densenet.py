...
model_urls = {
    ...
    "densenet169": "https://download.pytorcn.org/models/densenet169-b2777c0a.pth",
    ...
    if pretrained:
        ...
        for key in list(state_dict.keys()):
            ...
            if res:
                ...
                del state_dict[key]
        model.state_dict()["features.conv0.weight"][:, :3, ...] = state_dict[
            "features.conv0.weight"
        ].data

        pretrained_dict = {
            k: v for k, v in state_dict.items() if k != "features.conv0.weight"
        }
